...
public class TestFlock {
	public static void main(String[] args) {
		Flock f = new flockbase.FlockY(); // where FlockX is a concrete derived class of Flock

		// add a bunch of birds

		// repeat the above for the different derived classes of bird
		Bird b1 = new flockbase.BirdX(); // where BirdX is a derived concrete class of Bird
		b1.setPos(10,10);
		f.addBird(b1);
		
		for(int i=0;i<5;i++){
			Bird b = new flockbase.BirdX();
			b.setPos((i+1)*100,  10);
			f.addBird(b);
		}
